...
set :docker_image, "minimum2scp/ruby-binary:test_stretch-amd64_2.7.1"

describe "platform=stretch-amd64 version=2.7.1" do
  ...
  describe command("RBENV_VERSION=2.7.1 gem list --exact bundler") do
    let(:login_shell){ true }
    its(:stdout){ should eq "bundler (2.1.4, 1.17.3)\n" }
  end
