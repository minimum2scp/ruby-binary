...
set :docker_image, "minimum2scp/ruby-binary:test_sid-amd64_2.5.3"

describe "platform=sid-amd64 version=2.5.3" do
  ...
  describe command("RBENV_VERSION=2.5.3 ruby -rrbconfig -e 'puts RbConfig::CONFIG[\"LIBRUBY_RELATIVE\"]'") do
    let(:login_shell){ true }
