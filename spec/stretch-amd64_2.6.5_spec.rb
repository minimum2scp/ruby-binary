...
set :docker_image, "minimum2scp/ruby-binary:test_stretch-amd64_2.6.5"

describe "platform=stretch-amd64 version=2.6.5" do
  ...
  describe command("RBENV_VERSION=2.6.5 bundle -v") do
    let(:login_shell){ true }
    its(:stdout){ should eq "Bundler version 2.1.0\n" }
  end
