...
set :docker_image, "minimum2scp/ruby-binary:test_stretch-amd64_2.5.3"

describe "platform=stretch-amd64 version=2.5.3" do
  ...
  describe command("RBENV_VERSION=2.5.3 bundle -v") do
    let(:login_shell){ true }
    its(:stdout){ should eq "Bundler version 1.17.0\n" }
  end
